...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 12, 2024 at 08:15 AM
...
(1, 'LS001', 'Chí Phèo', 'Nam Cao', 'Tác phẩm văn học nổi tiếng về số phận của người nông dân Việt Nam', 'chi_pheo.jpg', 176, 50000, 10),
...
--
ALTER TABLE `sach`
  MODIFY `ID_SACH` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
