...
if (isset($_POST['save'])) {
    ...
    if ($_FILES['hinh_sach']['name']) {
        $hinh_sach = "uploads/" . basename($_FILES["hinh_sach"]["name"]);
    ...
    <div class="container mt-4">
        ...
        <form action="" method="post" enctype="multipart/form-data" class="mt-4">
            ...
            <div class="form-group">
                ...
                <input type="text" name="ma_loai" class="form-control" value="<?php echo isset($sach['MA_LOAI']) ? $sach['MA_LOAI'] : ''; ?>" required>
            </div>

            <div class="form-group">
                <label for="ten_sach">Tên Sách:</label>
                <input type="text" name="ten_sach" class="form-control" value="<?php echo isset($sach['TEN_SACH']) ? $sach['TEN_SACH'] : ''; ?>" required>
            </div>

            <div class="form-group">
                <label for="tac_gia">Tác Giả:</label>
                <input type="text" name="tac_gia" class="form-control" value="<?php echo isset($sach['TAC_GIA']) ? $sach['TAC_GIA'] : ''; ?>">
            </div>

            <div class="form-group">
                <label for="mo_ta">Mô Tả:</label>
                <textarea name="mo_ta" class="form-control"><?php echo isset($sach['MO_TA']) ? $sach['MO_TA'] : ''; ?></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="so_trang" class="form-control" value="<?php echo isset($sach['SO_TRANG']) ? $sach['SO_TRANG'] : ''; ?>">
            </div>

            <div class="form-group">
                <label for="gia">Giá:</label>
                <input type="number" name="gia" class="form-control" value="<?php echo isset($sach['GIA']) ? $sach['GIA'] : ''; ?>">
            </div>

            <div class="form-group">
                <label for="so_luong">Số Lượng:</label>
                <input type="number" name="so_luong" class="form-control" value="<?php echo isset($sach['SO_LUONG']) ? $sach['SO_LUONG'] : ''; ?>">
            </div>
