...
<form method="post" action="">
    ...
    <select name="shape" id="shape" onchange="this.form.submit()">
        <option value="circle" <?php if (isset($_POST['shape']) && $_POST['shape'] == 'circle') echo 'selected'; ?>>Hình tròn</option>
        <option value="triangle" <?php if (isset($_POST['shape']) && $_POST['shape'] == 'triangle') echo 'selected'; ?>>Hình tam giác</option>
        <option value="rectangle" <?php if (isset($_POST['shape']) && $_POST['shape'] == 'rectangle') echo 'selected'; ?>>Hình chữ nhật</option>
    </select>
